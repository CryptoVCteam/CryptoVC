...
contract Crypto is Initializable,UUPSUpgradeable,ERC20Upgradeable, ERC20PermitUpgradeable, ERC20VotesUpgradeable,ERC20VotesCompUpgradeable, OwnableUpgradeable, PausableUpgradeable {
    ...
    function initialize(        
        ...
        ERC20Upgradeable.__ERC20_init("Crypto DAO", "Crypto");
        ERC20PermitUpgradeable.__ERC20Permit_init("Crypto");
