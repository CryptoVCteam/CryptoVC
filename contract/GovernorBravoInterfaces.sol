...
contract GovernorBravoDelegateStorageV1 is GovernorBravoDelegatorStorage {
    ...
    /// @notice The address of the crypto Protocol Timelock
    TimelockInterface public timelock;

    /// @notice The address of the crypto governance token
    dCryptoInterface public dCrypto;
